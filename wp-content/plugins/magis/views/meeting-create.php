<form method="post" action="">
	...
	<div class="magis-meeting-panel">
		<div class="input-group">
			<input id="magis_meeting_uci" name="meeting-uci" type="text" placeholder="Cédula de Identidad" required/>
		...
		<div class="input-group">
			<input id="magis_meeting_uname" name="meeting-uname" type="text" placeholder="Nombre completo" required/>
		...
		<div class="input-group">
			<input id="magis_meeting_uphone" name="meeting-phone" type="text" placeholder="Teléfono celular" required/>
		...
		<div class="input-group">
			<select id="magis_meeting_ucity" name="meeting-city" placeholder="Ciudad" required>
