...
<div class="magis-meeting-date-card">
	...
	<p class="magis-meeting-date-label"><b>Fecha: </b> <span><?php echo $schedule->dia; ?></span></p>
	...
	<p class="magis-meeting-date-label"><b>Fecha de modificación: </b> <span><?php echo $themeeting->fecha_modificacion; ?></span></p>
</div>
